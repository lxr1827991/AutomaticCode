...
public class myEmis {
	...
	public static void main(String[] args) throws IOException {
		...
		String enname = "App";
		String tbname = "sys_app";
		String modular = "setting";
		...
		String jspBase = "E:\\eworkspace\\EMIS_MAVEN\\src\\main\\webapp\\jsp\\"+modular;
		
		map.put("jspBase", jspBase);
		map.put("jspName", new TlBean(enname).toLowerCaseFirst()+"_tolist.jsp");
...
/*	private void createListJsp(Map<String, Object> map) throws IOException {
		Map<String, Object> param = new HashMap<String, Object>();
		param.putAll(map);
		
		String outPath =param.get("basePath").toString()+ param.get("jspBase").toString()
				+"\\"+param.get("jspBase").toString();
		
		File f = new File(outPath);
		if(!f.exists()){f.getParentFile().mkdirs();f.createNewFile();}
			
		
		output(param, new InputStreamReader(getClass().getResourceAsStream("/template/_tolist.jsp"))
